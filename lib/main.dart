...
class IBM {
  void wat(String tx) async {
    final auth = IbmWatsonAssistantAuth(
      assistantId: 'f78a3df6-bb95-4a42-8df1-4516c698c8dc',
      url:
          'https://api.eu-gb.assistant.watson.cloud.ibm.com/instances/6e0bdba8-35a0-4aeb-8716-b0d472cfbffc',
      apikey: 'wHPfYOHnhXCUcKsIDU2puZpjejmYi5MUs__u_8fMwvqm',
    );
